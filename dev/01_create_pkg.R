...
## the following code:
#No correr esto si ya los tienes instalados!
#en terminal faltó este programa:
...
## Package names have some properties. You can also use: (está en el script anterior)
