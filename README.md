...
[GitHub](https://github.com/Steph0522/pkgMetagenomica) with:

``` r
BiocManager::install("Steph0522/pkgMetagenomica")
```
...
-   The [documentation
    website](http://Steph0522.github.io/pkgMetagenomica) is
